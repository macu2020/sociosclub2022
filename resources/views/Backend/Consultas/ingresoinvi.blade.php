@extends('Template.home')
 ...
 @section('title','Tabla-Ingreso Invitados')
@section('content')
		...
		<div class="container-fluid" style="margin-top: 110px;margin-bottom: 40px">
			...
			<div class="col-md-12"><!------ Table Category ---->
		   	 	<div class="panel shadow" style="border-top: 1px solid hsla(0, 0%, 71%, .3)">
				  	<div class="header">
				  		<h2 class="title"><i class="fas fa-users"></i> Ingreso  Invitados de {{ DATE(NOW()->format("Y-m-d")) }}</h2>
				  	</div>	
				    			...
				    			@foreach($datos as $element)
					    			<tr class=" text-center {{($element->role =='0')?'sinpriv':''}}">
						    			...
						    			<td class="text-center">								
											<div class="opciones" >
												<a href="{{url('/edit/'.$element->idinvit.'/inviconsul')}}   "  data-id=" "  data-toggle="tooltip" data-placement="top" title="editar"><img src="{{asset('img/iconos/icoedit.png')}}" style="width: 30px"></a>
