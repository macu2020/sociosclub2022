		...
		<div class="container-fluid" style="margin-top: 110px;margin-bottom: 40px">
			...
			<div class="col-md-9"><!------ Table Category ---->
		   	 	<div class="panel shadow" style="border-top: 1px solid hsla(0, 0%, 71%, .3)">
				  	<div class="header">
				  		<h2 class="title"><i class="fas fa-user-plus"></i> Nuevo Socio</h2>
				  	</div>	
 			    		
					{!! Form::open(['url'=>'/add-soc','method'=>'POST','class'=>'col-md-9 col-xs-12 regis-form','id'=>'save_soci','files'=>true,])!!}	
     	  			...
     	  			<div class="row"> <!------- Name -Lastname --------->
     	   			...
     	   			<div class="row"> <!--------- DNI - Perfil --------->
				     	  ...
				     	  <div class="form-group">
						    ...
						    {!!Form::number('dni',old('dni'),['class'=>'form-control' ,'id'=>'dni'])!!}
							@if($errors->any('dni'))
				     	  ...
				     	  <div class="form-group  text-center">
								...
								@if ($perfi != null)
			  					<select name="selecperfil"  class="custom-select text-center" id="selecperfil" >
			  						<option value=""  >-- seleccione --</option>
			  						@foreach ($perfi as $element)
     	   			...
     	   			<div class="row" id="rowtit"><!-- CLAVE - SOCIO ---->
                			...
                			<div class="form-group text-center">
                				...
                				<input type="text" class="form-control text-center inputcla" name="clavetit" id="clavetit">
              				</div>
                		</div> 
     	   			</div>
						    ...
						    <label for="selecatego" class="subtit">Categoria</label>
						    	@if ($class != null)
			  					<select name="selecatego"  class="custom-select "  >
			  						...
			  						<option value="{{ $element->id }}"  >{{ $element->clase }}</option>
			  						@endforeach
			  					</select>
			  					@else
		     	  	...
		     	  	<div class="row"><!-- Socios email --->
						  ...
						  <div class="form-group">
							...
							{!!Form::text('placa_socio',old('placa_socio'),['class'=>'form-control' ,'placeholder'=>'Placa','id'=>'placa_socio'])!!}
